...
<main class="booking-container">
    <div class="booking-form">
        ...
        <form action="{{ route('students.booking-form.store', $facility->id) }}" method="POST">
            @csrf

            <table class="booking-table">
                <tr>
                    <td><label>Student ID</label></td>
                    <td><input type="text" name="student_id" value="{{ session('student_id') }}" readonly></td>
                </tr>

                <tr>
                    <td><label>Student Name</label></td>
                    <td><input type="text" name="student_name" value="{{ session('student_name') }}" readonly></td>
                </tr>

                <tr>
                    <td><label>Facility</label></td>
                    <td><input type="text" name="facility" value="{{ $facility->faculty_name }}" readonly></td>
                </tr>
